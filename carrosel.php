<div id="banners" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="images/Rodizio.png" alt="" class="center-block">
            </div>
            <div class="item ">
                <img src="images/Rodizio (2).png" alt="" class="center-block">
            </div>
            <div class="item ">
                <img src="images/Rodizio (3).png" alt="" class="center-block">
            </div>
        </div>
